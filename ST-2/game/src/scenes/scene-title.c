...
#endif
#include "../../text/title-snail.h"
#include "../../text/title-start.h"
#include "../../text/title-bonus.h"
#include "../../text/title-comma.h"
#include "../../text/title-pts.h"
void sceneTitleMain(u16 scene_ct)
{
    ...
    if (!(scene_ct & flash)) {
        printSetAddr((u8*)VVRAM_TEXT_ADDR(10, 17)); printString(text_title_start);
    }
...
// ---------------------------------------------------------------- タイトル ロゴ表示
#include "../../cg/title-s.h"
#include "../../cg/title-t.h"
#include "../../cg/title-hyphen.h"
#include "../../cg/title-2.h"
