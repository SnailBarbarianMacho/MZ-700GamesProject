...
void main()
{
    // 画面書き込みと音のテスト
    u8 c = 0;
    static const u8* VRAM_START = (const u8*)0xd000;
    static const u8* VRAM_END   = (const u8*)0xd000+1000;
    static volatile u8* const SOUND = (const u8*)0xe004;

	while (1)
    {
        // 音を出す
        *((volatile u8*)0xe004) = c;
        *((volatile u8*)0xe004) = c;
