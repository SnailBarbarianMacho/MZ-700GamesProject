...
// ---------------------------------------------------------------- システム
/** VRAM システムの初期化 */
void vvramInit(void) __z88dk_fastcall;
 ...
 */
void vvramTrans(void) __z88dk_fastcall;
 ...
 * @param wh ((W << 8) | H).   common.h の W8H8 マクロを使うと便利です
 */
void vvramDrawRect(const u8* const draw_addr, const u8* const src_addr, const u16 wh);
 ...
 * @param wh ((W << 8) | H).   common.h の W8H8 マクロを使うと便利です
 */
void vvramDrawRectTransparent(const u8* const draw_addr, const u8* const src_addr, const u16 wh);
 ...
 * @param wh ((W << 8) | H).   common.h の W8H8 マクロを使うと便利です
 */
void vramDrawRect(const u8* const draw_addr, const u8* const src_addr, const u16 wh);
