 ...
 *   ------------------------------------------------------------
 *     ch1         0～1     R,B1～C6    0      Lead ※Beeper1は Beeper0 のエコー
 *     ch2         0～1     R,A1～B1    なし   LeadSub
 *     ch5         0～1     R,B1～C6    1      Base
 *     ch6         0～2     R,B1～C6    2      Chord x 2(アルペジオ)
 *     ch10        0～1     R,B1～C#2   3      Drum
 *     ch3, ch4は欠番
 *
 *   - 音階についての注意:
 *     - C5 以降の高音は精度落ちるので実用は3オクターブ程度
 *     - 絶対音階ではありません (A4 == 440Hz ではありません)
 *   - 音色: Lead    ... Piano1/2/3 = エンベロープ■/◣/◢
